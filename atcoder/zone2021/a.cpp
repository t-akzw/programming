...
void solve() {
  ...
  rep(i, n) {
    //debug(s[i]);
    if(state == 3 && s[i] == 'e') state = 4;
    if(state == 3 && s[i] != 'e') state = 0;
    if(state == 2 && s[i] == 'N') state = 3; 
    if(state == 2 && s[i] != 'N') state = 0; 
    if(state == 1 && s[i] == 'O') state = 2; 
    if(state == 1 && s[i] != 'O') state = 0; 
    if(state == 0 && s[i] == 'Z') state = 1; 
    if(state == 4) {
      ans += 1;
      state = 0;
    }
